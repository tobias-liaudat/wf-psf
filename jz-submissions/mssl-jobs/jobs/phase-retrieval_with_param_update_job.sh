...
time /disk/xray0/tl3/miniconda3/envs/tf2_7_conda/bin/python -u train_eval_plot_script_click_multi_cycle.py \
    --id_name _wf_PR_12_cycles_v1_param_update \
    --suffix_id_name v1_param_update \
    ...
    --chkp_save_path /unsafe/data1/tl3/outputs/wf-phase-retrieval/wf-outputs/chkp/12_cycles_param_update/ \
    --plots_folder plots/12_cycles_param_update/ \
    --model_folder chkp/12_cycles_param_update/ \
