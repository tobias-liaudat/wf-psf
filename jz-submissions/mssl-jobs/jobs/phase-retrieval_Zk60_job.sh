...
time /disk/xray0/tl3/miniconda3/envs/tf2_7_conda/bin/python -u train_eval_plot_script_click_multi_cycle.py \
    --id_name _wf_PR_12_cycles_v1_Zk60 \
    --suffix_id_name v1_Zk60 \
    ...
    --chkp_save_path /unsafe/data1/tl3/outputs/wf-phase-retrieval/wf-outputs/chkp/12_cycles_Zk60/ \
    --plots_folder plots/12_cycles_Zk60/ \
    --model_folder chkp/12_cycles_Zk60/ \
